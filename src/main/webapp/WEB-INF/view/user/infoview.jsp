...
<div style="left:0px;" class="b-valign  b-valign--origin-left">
  <div class="b-valign__inner" >
      <h2 class="headline is_vaporable" style="opacity: 3.27318;">내 프로필</h2>
  </div>
</div>
  </div>
</div>
...
<div class="b-form-list b-form-list--top">
  ...
  <div class="b-form-list">
    <label class="b-form__label text-size_xs">
      아이디
</label>    <input class="b-form__item form-field col-5"  type="text" value="${user.id }" readonly> 
  </div>
<div class="b-form-list">
    <label class="b-form__label text-size_xs">
      닉네임
</label>    <input class="b-form__item form-field col-3" type="text" value="${user.nic }" readonly> 
  </div>
...
<fmt:formatDate  var="date2" value="${user.signdate }" type="DATE" pattern="yyyy-MM-dd"/>
  ...
  <div class="b-form-list">
    <label class="b-form__label text-size_xs">
   전화번호
</label>    <input class="b-form__item form-field col-5" type="search" value="${user.tel }" readonly> 
  </div>
  <div class="b-form-list b-form-list--top">
    <label class="b-form__label text-size_xs" for="user_short_description">
      소개글
</label>    <div class="b-form__item col-12">
      <textarea class="form-field" rows="3" readonly >"${user.story }" </textarea>
    </div>
  </div>
</div>
</div></div> 
